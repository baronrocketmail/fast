...
export default function Nav(props) {
    ...
    if (props.showSettings) elements.push(<div className={"themeToggle"}><svg  width={"4vh"} height={"4vh"}  viewBox="0 0 24 24">
    ...
    </svg><svg  width={"4vh"} height={"4vh"}  viewBox="0 0 24 24">
